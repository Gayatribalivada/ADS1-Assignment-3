...
def curvefitPlot(time_data, debt_service_data, result):
    """
...
debt_service_data = cleaned_data['CO2 emissions (metric tons per capita)']
...
curvefitPlot(time_data, debt_service_data, result)
...
plt.figure(figsize=(12, 8))
sns.lineplot(x=time_data, y=debt_service_data, label='CO2 Emissions (Actual)', color='blue', linewidth=2)
